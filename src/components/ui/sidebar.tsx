        ...
        <Sheet open={openMobile} onOpenChange={setOpenMobile} defaultOpen={defaultOpen} {...restProps}>
          ...
          >
            <SheetHeader className="sr-only">
              ...
              <SheetDescription>Main navigation and actions.</SheetDescription>
            </SheetHeader>
