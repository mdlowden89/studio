...
export function EmotionalHotspotsUpsell({ onUnlock }: EmotionalHotspotsUpsellProps) {
  return (
    <div className="relative w-full h-full overflow-hidden rounded-lg bg-gradient-to-br from-primary/10 via-card to-card p-6 flex flex-col items-center justify-center text-center border border-primary/30">
