  ...
  useEffect(() => {
    ...
    async function redirectToStripeCheckout() {
      ...
      if (error) {
        ...
        // trying to redirect (e.g., network issue, invalid session ID).
        // If successful, the user is navigated away.
      ...
      // If redirectToCheckout is successful, this component will likely be unmounted
      // as the browser navigates to Stripe.
    }
